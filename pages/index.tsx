        ...
        <div className="w-11/12 h-[448px] bg-blueBg rounded-t-[100px] mx-auto pt-[34px] xs:w-[325px] md:w-11/12 md:rounded-t-[200px] md:flex md:items-center md:justify-center lg:w-[969px]">
          <div className="md:grid md:grid-cols-2 md:items-center">
            ...
            <div className="text-center mx-auto w-[274px] lg:w-[365px] md:mx-0">
              ...
              <p className="body-text font-inter text-white mt-[14px] mb-[34px] mx-auto">{"BHCC aims to support individuals and families to develop new skills and take ownership of their lives following a program that is tailor-made to match everyone's needs."}</p>
              <Button
                href="/"
                title="Learn More"
