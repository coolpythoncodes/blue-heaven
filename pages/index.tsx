    ...
    <Layout navBarColor="bg-blueBg">
      ...
      <section className="layout-container mt-[109px] xs:mt-[243px]">
        <div className="text-center w-[307px] mx-auto xs:w-full lg:w-[918px]">
          ...
          <p className="body-text font-inter xs:heading-3">BHCC aims to support individuals and families to develop new skills and take ownership of their lives following a program that is tailor-made to match everyone&lsquo;s needs. </p>
        </div>
        ...
        <div className="w-11/12 h-[448px] bg-blueBg rounded-t-[100px] mx-auto pt-[34px] xs:w-[325px] md:w-11/12 md:rounded-t-[200px] md:flex md:items-center md:justify-center lg:w-[969px]">
          <div className="md:grid md:grid-cols-2 md:items-center">
            ...
            <div className="text-center mx-auto w-[274px] lg:w-[365px] md:mx-0">
              ...
              <p className="body-text font-inter text-white mt-[14px] mb-[34px] mx-auto">BHCC aims to support individuals and families to develop new skills and take ownership of their lives by following a tailor-made program to match everyone&lsquo;s needs. </p>
              <Button
                href="/"
                title="Learn More"
