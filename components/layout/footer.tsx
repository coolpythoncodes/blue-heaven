import { footer_contact, footer_links } from "../../utils/data"
                            ...
                            <div className="flex justify-center space-x-12 mb-[31px] md:mb-0 xl:space-x-[100px]">
                                {
                                    footer_links.map((value, index) => (
                                        <div key={index} className="text-center">
                                            <h3 className="font-inter text-base font-semibold md:button-text lg:mb-[15px]">{value.header}</h3>
...
//             <div className="error absolute -top-[110px] right-[65px] w-[198px] h-[127px] md:w-[499px] md:h-[320px] md:-top-[280px] md:right-[130px] lg:right-[180px]">
//                 <Image src={people} alt="" layout="responsive"/>
//             </div>
//             <div className="bg-blueBg text-white pt-[21px] pb-[98px] border rounded-t-[100px] md:rounded-t-[200px] md:pb-[33px] md:pt-[53px]">
//                 <div className="mx-auto w-11/12">
//                     <div className="lg:flex lg:items-center lg:w-11/12 lg:mx-auto lg:justify-between error">
//                         <div className="w-12 h-[71px] mx-auto mb-[21px] md:w-[72px] md:h-[135px] lg:mx-0">
//                             <Image src={logo} alt="blue heaven logo" layout="responsive"/>
//                         </div>
//                         <div className="lg:grid lg:grid-cols-2">
//                             <div className="flex justify-center space-x-12 mb-[31px] md:space-x-20 error lg:mb-0">
//                                 {
//                                     footer_links.map((value, index) => (
//                                         <div key={index} className="text-center">
